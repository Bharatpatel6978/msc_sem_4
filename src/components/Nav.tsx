...
function Nav({user}:{user:IUser}) {
  ...
  return (
    <div className='w-[95%] fixed top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-green-500 to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50'>
        <Link href={"/"} className='text-white font-extrabold text-2xl sm:text-2xl sm:text-3xl tracking-wide hover:scale-105 transition-transform'>
            SK MART
        </Link>
        ...
        <div className="flex items-center gap-3 md:gap-6 relative">
            ...
            <div className="bg-white rounded-full w-11 h-11 flex items-center justify-center overflow-hidden shadow-md hover:scale-105 transition-transform relative cursor-pointer">
