  ...
  return (
      <div className="flex flex-col items-center min-h-screen p-6 w-full">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-10">
          {roles.map((role)=>{
            ...
            return(
              ...
              className={`flex cursor-pointer flex-col items-center justify-center w-48 h-44 rounded-2xl border-2
              transition-all ${
                isSelected
        ...
        >
          ...
          type="tel" 
          id='mobile' 
          className='w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none text-shadow-gray-800' placeholder='eg. 0000000000' />
