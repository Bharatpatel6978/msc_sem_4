...
function OrderSuccess() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
      ...
      >
        Thank you for shopping with SK Mart. We are processing your order and will update you shortly.You can track your order in your <span className="font-semibold text-green-700">My Orders</span> section.
      </motion.p>
      <motion.div
